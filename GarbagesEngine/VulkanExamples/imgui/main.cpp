...
#include "../../VulkanBase/Entrypoints.h"
...
public:
	...
	void newFrame(VulkanExampleBase *example, bool updateFrameGraph)
	{
		...
		// Debug window
		ImGui::SetWindowPos(ImVec2(20 * example->ui.scale, 20 * example->ui.scale), ImGuiCond_FirstUseEver);
		ImGui::SetWindowSize(ImVec2(300 * example->ui.scale, 300 * example->ui.scale), ImGuiCond_Always);
		...
		ImGui::SetNextWindowPos(ImVec2(20 * example->ui.scale, 360 * example->ui.scale), ImGuiCond_FirstUseEver);
		ImGui::SetNextWindowSize(ImVec2(300 * example->ui.scale, 200 * example->ui.scale), ImGuiCond_FirstUseEver);
